...
namespace ISTAT.SingleSignON.Service
{
    public class SingleSignONService : ISingleSignONService
    {
        ...
        {
            ISTAT.SingleSignON.Service.Model.Configuration config = new ISTAT.SingleSignON.Service.Model.Configuration(ConfigurationManager.ConnectionStrings["ISTATWebClientSSO"].ConnectionString);
        }
        ...
        public ISTATUser Login(LoginObj login)
        {
            try
            {
                ISTAT.SingleSignON.Service.Model.DBUserEntities cnn = new ISTAT.SingleSignON.Service.Model.DBUserEntities(ConfigurationManager.ConnectionStrings["ISTATWebClientSSO"].ConnectionString);
        ...
        public List<ISTATUser> GetUserList()
        {
            try
            {
                ISTAT.SingleSignON.Service.Model.DBUserEntities cnn = new ISTAT.SingleSignON.Service.Model.DBUserEntities();
        ...
        public bool ChangePassword(PasswordObj passobj)
        {
            try
            {
                ...
                if (ris == 0)
                    throw new Exception(string.Format("Old and new password are equal"));
            ...
            {
                throw new Exception(string.Format("Change Password Error: {0}", ex.Message));
            }
        }
