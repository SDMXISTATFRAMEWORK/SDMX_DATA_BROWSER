namespace ISTAT.WebClient.WidgetEngine.Model.DBData
{
    ...
    /// <summary>
    /// An implementation that stores the sdmx dataset in a temporary table.
    /// It requires permission to create a table and drop it.
    /// </summary>
    public class DataSetStoreDB : IDataSetStore
    {
