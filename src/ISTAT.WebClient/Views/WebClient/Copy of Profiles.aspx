...
<asp:Content ID="Footercontainer" ContentPlaceHolderID="ContentFooter" runat="server">
    <script type="text/javascript">
        var _endPoint2 = "<%=ConfigurationManager.AppSettings["SingleSignOnUrl"].ToString() %>";
        ...
        function removeUser(userCode, _endPoint) {
            ...
            $.ajax({
                type: "POST",
                url: _endPoint+"Profiles/GetUser",
                async: true,
