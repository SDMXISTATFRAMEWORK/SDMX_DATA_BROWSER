    ...
    <script type="text/javascript">
        ...
        function addWebServ() {
            ...
            $(createWS).append("<div class='containerPop'>"+
                                ...
                                "<div class='div_inputPop'><div class='lab_inputPop'>ORDINAMENTO</div><div class='divInp'><input class='inputPop' readonly id='Ordinamento' type='text' value='0'/></div><div class='clear-box'></div></div>" +      
                                "</div>");
                ...
                buttons: {
                    '<%=Messages.label_save%>': function () {
                        ...
                        if ((!( (checkLetter($(createWS).find("#IDNode").val()))
                            ...
                            //alert(clientParseObjectToJson(ws_obj));
                            saveWS(ws_obj);
        ...
        function modifyWS(objWS,objWSTitle) {
            ...
            //alert(clientparseobjecttojson(objWS));
            ...
            $(updateWS).append("<div class='containerPop'>"+
                                ...
                                "<div class='div_inputPop'><div class='lab_inputPop'><%=Messages.label_enableHttpWS %></div><div class='divInp'>"+
                                    "<input class='inputPop' id='EnableHTTPAuthentication' type='checkbox' "+ (objWS.EnableHTTPAuthentication? "checked":"")+ " value='"+objWS.EnableHTTPAuthentication+"' onclick='enable_HTTPAuthentication();'/></div>"+
                                ...
                                "<div class='div_inputPop'><div class='lab_inputPop'><%=Messages.label_enablePoxyWS %></div><div class='divInp'>"+
                                    "<input class='inputPop' id='EnableProxy' type='checkbox' value='"+objWS.EnableProxy+"' "+ (objWS.EnableProxy? "checked":"")+ " onclick='enable_Proxy();'/></div>"+
                                "<div class='clear-box'></div></div>" +                                
                                "<div class='div_inputPop'><div class='lab_inputPop'><%=Messages.label_useSystemProxyWS %></div><div class='divInp'>"+
                                    "<input disabled class='inputPop' id='UseSystemProxy' type='checkbox' value='"+objWS.UseSystemProxy+"' "+ (objWS.UseSystemProxy? "checked":"")+ "/></div>"+
                                "<div class='clear-box'></div></div>" +
                                ...
                                "<div class='div_inputPop'><div class='lab_inputPop'><%=Messages.label_useUncategorysed %></div><div class='divInp'>"+
                                    "<input class='inputPop' id='UseUncategorysed' type='checkbox'  "+ (objWS.UseUncategorysed? "checked":"")+ " value='"+objWS.UseUncategorysed+"'/></div>"+
                                "<div class='clear-box'></div></div>" +
                                "<div class='div_inputPop'><div class='lab_inputPop'><%=Messages.label_useVirtualDF %></div><div class='divInp'>"+
                                "<input class='inputPop' id='UseVirtualDf' type='checkbox' "+ (objWS.UseVirtualDf? "checked":"")+ " value='"+objWS.UseVirtualDf+"'/></div>"+
                                "<div class='clear-box'></div></div>" +
                ...
                buttons: {
                    '<%=Messages.label_save%>': function () {
                        ...
                        if ((!( (checkLetter($(updateWS).find("#IDNode").val()))
                            ...
                            //rimuovo il vecchio che ho modificato
                            //$(objWSTitle).remove();
                            //saveAll();
                            updWS(ws_obj);
        ...
        function saveWS(ws_obj,callback) {
            var minSel = true;
            ...
            if (minSel) {
                ...
                clientPostJSON(
                    "Settings/AddWS", clientParseObjectToJson(ws_obj),
                    function (jsonString) {
        ...
        function deleteWS(ws_obj,callback) {
            var minSel = true;
            ...
            if (minSel) {
                ...
                clientPostJSON(
                    "Settings/DelWS", clientParseObjectToJson(ws_obj),
                    function (jsonString) {
        ...
        function updWS(ws_obj,callback) {
            var minSel = true;
            ...
            if (minSel) {
                ...
                clientPostJSON(
                    "Settings/UpdWS", clientParseObjectToJson(ws_obj),
                    function (jsonString) {
        ...
        function saveOpt(callback) {
            ...
            if (minSel) {
                //alert(clientParseObjectToJson(data));

                clientPostJSON(
                    "Settings/UpdOpt", clientParseObjectToJson(data),
                    function (jsonString) {
        ...
        function saveAll(callBack) {
            ...
            if (minSel) {
                ...
                clientPostJSON(
                    "Settings/SetSettingsWS", clientParseObjectToJson(data),
                    function (jsonString) {
                    ...
                    function (jsonString) {
                        ...
                        if (_sett_obj != "") {
                            ...
                            $.each(endpoints, function (index, value) {
                                ...
                                $(div2).html("<b>"+value.Title + "</b> -&nbsp;&nbsp;&nbsp;Endpoint:&nbsp;<a href='"+ value.EndPoint +"' target='_blank'>" + value.EndPoint + "</a> - " + value.Ordinamento);
                                ...
                                $(button).click(function () { deleteWS(value); });
                                ...
                                //$(button).click(function () { updateWS(value); });
                        ...
                        $("#id_view_tree").append('<input id="view_tree" type="checkbox" ' + (((_sett_obj != "") ? _sett_obj.settings.view_tree == true : false) ? 'checked="checked"' : '') + ' name="view_tree" onclick="saveOpt();"/><i class="icon-flow-cascade"></i><label><%= Messages.label_tree_display%></label>');
                        $("#id_view_tree_req").append('<input id="view_tree_req" type="checkbox" ' + (((_sett_obj != "") ? _sett_obj.settings.view_tree_req == true : false) ? 'checked="checked"' : '') + ' name="view_tree_req" onclick="saveOpt();"/><i class="icon-flow-cascade"></i><label><%= Messages.label_tree_display_request%></label>');
                        $("#id_more_ws").append('<input id="more_ws" type="checkbox" ' + (((_sett_obj != "") ? _sett_obj.settings.view_tree_select == true : false) ? 'checked="checked"' : '') + ' name="more_ws" onclick="saveOpt();"/><i class="icon-table"></i><label><%= Messages.label_more_web_services%></label>');
